<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <p><strong>Pemilik:</strong> <?php echo $owner ? $owner->name : 'Unknown'; ?> (<?php echo $owner ? $owner->email : '-'; ?>)</p>
    ...
    <div class="mt-3">
        <?php if ($kosan->status == 'inactive'): ?>
            <a href="<?php echo site_url('dashboard/verify_kosan/' . $kosan->id); ?>" class="btn btn-success">Verifikasi</a>
            <a href="<?php echo site_url('dashboard/reject_kosan/' . $kosan->id); ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin menolak kosan ini?')">Tolak</a>
        <?php endif; ?>
        <a href="<?php echo site_url('dashboard/admin'); ?>" class="btn btn-secondary">Kembali</a>
    </div>
</div>