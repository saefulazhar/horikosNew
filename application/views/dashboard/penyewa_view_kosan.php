<div class="container">
    ...
    <div class="mt-3">
        <?php if ($kosan->available_rooms > 0): ?>
            <a href="<?php echo site_url('dashboard/reserve_kosan/' . $kosan->id); ?>" class="btn btn-success">Reservasi Sekarang</a>
        <?php else: ?>
            <button class="btn btn-secondary" disabled>Kamar Penuh</button>
        <?php endif; ?>
